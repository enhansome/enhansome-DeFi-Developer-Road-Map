...
* Learn the basics of [Computer Science](https://github.com/ossu/computer-science) ⭐ 209,099 | 🐛 28 | 🌐 HTML | 📅 2026-07-14
...
* Read Book [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,531 | 🐛 1 | 📅 2026-08-31 and watch [this channel](https://www.youtube.com/channel/UCJWh7F3AFyQ_x01VKzr9eyA/videos)
...
* [WTF Solidity](https://github.com/AmazingAng/WTF-Solidity) ⭐ 14,051 | 🐛 33 | 🌐 Solidity | 📅 2026-08-23
...
* [ERC-721](https://github.com/ethereum/eips/issues/721) ⭐ 13,977 | 🐛 522 | 🌐 Python | 📅 2026-09-18 - Token standard for non-fungible assets.
...
* [Viem Library](https://github.com/wagmi-dev/viem) ⭐ 3,555 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-18
...
* [Web3modal](https://github.com/WalletConnect/web3modal) ⭐ 5,440 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-18
...
* [Vyper](https://github.com/vyperlang/vyper) ⭐ 5,180 | 🐛 626 | 🌐 Python | 📅 2026-09-17
...
* [Foundry](https://github.com/onbjerg/foundry-book) ⭐ 963 | 🐛 72 | 🌐 MDX | 📅 2026-09-17 - A smart contract development toolchain for project compilation, dependency management, testing, deployments, on-chain interactions...
...
* [Artemis](https://github.com/PegaSysEng/artemis) ⭐ 779 | 🐛 237 | 🌐 Java | 📅 2026-09-17 - Java implementation of the Ethereum 2.0 Beacon Chain by PegaSys
...
* [Metamask ui](https://github.com/MetaMask/metamask-storybook) ⭐ 36 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - Metamask React Components
...
* [Public APIs](https://github.com/public-apis/public-apis#cryptocurrency) ⭐ 481,304 | 🐛 1,947 | 🌐 Python | 📅 2026-09-17
...
* [Zeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,242 | 🐛 364 | 🌐 Solidity | 📅 2026-09-17 - Contains tested reusable smart contracts like SafeMath and OpenZeppelin SDK [library](https://github.com/OpenZeppelin/openzeppelin-sdk) ⚠️ Archived for smart contract upgradeability
...
* [OpenZeppelin Contracts: An open framework of reusable and secure smart contracts in the Solidity language.](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,242 | 🐛 364 | 🌐 Solidity | 📅 2026-09-17
...
* [Erigon](https://github.com/ledgerwatch/erigon) ⭐ 3,584 | 🐛 674 | 🌐 Go | 📅 2026-09-18 - a mostly Go implementation of Ethereum client built on the efficiency frontier
...
* [Nethermind](https://github.com/NethermindEth/nethermind) ⭐ 1,598 | 🐛 329 | 🌐 C# | 📅 2026-09-18 - .NET Core client
...
* [rocketh](https://github.com/wighawag/rocketh) ⭐ 35 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - A simple lib to test ethereum smart contract that allow to use whatever web3 lib and test runner you choose.
